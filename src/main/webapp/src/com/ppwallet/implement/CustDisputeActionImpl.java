...
public class CustDisputeActionImpl implements Action{
	
	private String rulesaction = null;
	private Rules rules;
	private static String classname = CustDisputeActionImpl.class.getSimpleName();
	...
	public void perform(String action, HttpServletRequest request, HttpServletResponse response, ServletContext ctx)
		...
		try{
        	...
        	if(request.getParameter("rules")!=null)    	
        		rulesaction = request.getParameter("rules");
//        	PPWalletEnvironment.setComment(1,classname,"Exception is "+rulesaction);
