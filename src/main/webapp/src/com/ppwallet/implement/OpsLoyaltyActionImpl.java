...
public class OpsLoyaltyActionImpl implements Action {
	private String rulesaction = null;
	private Rules rules;
	private static String className = OpsLoyaltyActionImpl.class.getSimpleName();
		 ...
		 try{
	        	...
	        	if(rulesaction!=null){
	        		//request.setAttribute("lastrules", rulesaction);
						...
						PPWalletEnvironment.setComment(3,className," pased22");

	        	}else{
					PPWalletEnvironment.setComment(3,className," pased2");
